    ...
    if room = tut_1
    {
      ...
      draw_set_font(TutFontSmall)
      draw_text_shadow(150,room_height*3/4,'Click to launch it off the screen!',c_white,c_black,1)
    }
      
    else if room = tut_2
    {
      draw_set_font(TutFontBig)
      draw_text_shadow(room_width/4,room_height/4,'Clicking futher away# sends it further',c_white,c_black,1)
      draw_set_font(TutFontSmall) 
    ...
    else if room = tut_3
    {
      ...
      draw_set_font(TutFontSmall) 
      draw_text_shadow(150,room_height/4,'A close click#Gives a more gental jump',c_white,c_black,1)
    }   
    draw_set_alpha(1)
